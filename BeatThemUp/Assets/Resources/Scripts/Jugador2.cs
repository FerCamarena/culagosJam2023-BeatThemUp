...
public class Jugador2 : MonoBehaviour {
    ...
    private void Update()
    {
        ...
        if (this.state == States.Idle) {
            ...
            } else if (Input.GetKeyDown(KeyCode.Keypad6) || Input.GetButtonDown("Simple2")) {
                //Debug.Log("X");
                this.state = States.Simple;
            } else if (Input.GetKeyDown(KeyCode.Keypad9) || Input.GetButtonDown("Strong2")) {
                //Debug.Log("B");
                this.state = States.Strong;
            } else if (Input.GetKeyDown(KeyCode.Keypad0) || Input.GetButtonDown("Jump2")) {
                //Debug.Log("Jump");
                this.state = States.Jump;
            } else if (Input.GetKey(KeyCode.RightControl) || Input.GetButtonDown("Block2")) {
                //Debug.Log("Block");
                this.state = States.Block;
            }
        } else if (this.state == States.Walk) {
            if ((Input.GetKey(KeyCode.Keypad6) || Input.GetButtonDown("Simple2")) && (this.rb.velocity.x < -3.0f || this.rb.velocity.x > 3.0f)) {
                //Debug.Log("Charge X");
                this.state = States.Simple;
            } else if ((Input.GetKey(KeyCode.Keypad9) || Input.GetButtonDown("Strong2")) && (this.rb.velocity.x < -3.0f || this.rb.velocity.x > 3.0f)) {
                //Debug.Log("Charge B");
                this.state = States.Strong;
            } else if (Input.GetKeyDown(KeyCode.Keypad0) || Input.GetButtonDown("Jump2")) {
                //Debug.Log("Jump");
                this.state = States.Jump;
            } else if (Input.GetKeyDown(KeyCode.RightControl) || Input.GetButtonDown("Block2")) {
                //Debug.Log("Block");
                this.state = States.Block;
            }
            if(!jumping) {
            ...
            if (Input.GetKeyUp(KeyCode.RightControl) || Input.GetButtonUp("Block2")) {
                //Debug.Log("End block");
                this.state = States.Idle;
            }
        } else if (this.state == States.Jump) {
            if (Input.GetKeyDown(KeyCode.Keypad9) || Input.GetButtonDown("Simple2")) {
                //Debug.Log("Air X");
                this.state = States.Simple;
            } else if (Input.GetKeyDown(KeyCode.Keypad9) || Input.GetButtonDown("Strong2")) {
                //Debug.Log("Air B");
            ...
            if (Input.GetKeyDown(KeyCode.Keypad6) || Input.GetButtonDown("Simple2")) {
                //Debug.Log("Combo X");
            ...
            if (Input.GetKeyDown(KeyCode.Keypad9) || Input.GetButtonDown("Strong2")) {
                //Debug.Log("XXB");
                this.state = States.Strong;
            } else if (Input.GetKeyDown(KeyCode.Keypad0) || Input.GetButtonDown("Jump2")) {
                //Debug.Log("XX Jump X");
    ...
    private void Move() {
        if ((state == States.Idle || state == States.Walk) && !jumping) { 
            ...
            if(Input.GetAxisRaw("Horizontal2") != 0.0f) {
                velocity.x = Input.GetAxisRaw("Horizontal2") * 1.4f;
